...
export class HealthCenterManagementService {
  constructor(
 ...
 getAllHealthCenters<TData = PagedModelHealthCenterResponseDTO>(
  ...
  ): Observable<HttpEvent<TData>>;getAllHealthCenters<TData = PagedModelHealthCenterResponseDTO>(
...
export type GetAllHealthCentersClientResult = NonNullable<PagedModelHealthCenterResponseDTO>
