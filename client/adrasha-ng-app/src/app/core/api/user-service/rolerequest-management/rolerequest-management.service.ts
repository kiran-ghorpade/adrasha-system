...
export class RolerequestManagementService {
 ...
 getAllRoleRequests<TData = PagedModelRoleRequestResponseDTO>(
  ...
  ): Observable<HttpEvent<TData>>;getAllRoleRequests<TData = PagedModelRoleRequestResponseDTO>(
 ...
 getTotalRoleRequests<TData = GetTotalRoleRequests200>(
  ...
  ): Observable<HttpEvent<TData>>;getTotalRoleRequests<TData = GetTotalRoleRequests200>(
...
export type GetAllRoleRequestsClientResult = NonNullable<PagedModelRoleRequestResponseDTO>
...
export type GetTotalRoleRequestsClientResult = NonNullable<GetTotalRoleRequests200>
