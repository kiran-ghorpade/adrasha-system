...
export class MemberManagementService {
 ...
 getAllMembers<TData = PagedModelMemberDataResponseDTO>(
  ...
  ): Observable<HttpEvent<TData>>;getAllMembers<TData = PagedModelMemberDataResponseDTO>(
...
export type GetAllMembersClientResult = NonNullable<PagedModelMemberDataResponseDTO>
