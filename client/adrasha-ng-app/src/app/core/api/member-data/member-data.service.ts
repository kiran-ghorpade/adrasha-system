...
export class MemberDataService {
  ...
  getAllMembers<TData = MemberDataPageResponseDTO>(
    ...
    return this.http.get<TData>(`http://localhost:8080/data/members`, {
      ...options,
      ...params,
      ...options?.params,
    });
  ...
  getTotalCount<TData = string>(
    ...
    return this.http.get<TData>(`http://localhost:8080/data/members/count`, {
      ...options,
      ...params,
      ...options?.params,
    });
