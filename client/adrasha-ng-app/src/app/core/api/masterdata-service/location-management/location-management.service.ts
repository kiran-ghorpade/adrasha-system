...
export class LocationManagementService {
 ...
 getAllLocations<TData = PagedModelLocationResponseDTO>(
  ...
  ): Observable<HttpEvent<TData>>;getAllLocations<TData = PagedModelLocationResponseDTO>(
 ...
 getTotalCount<TData = GetTotalCount200>(
  ...
  ): Observable<HttpEvent<TData>>;getTotalCount<TData = GetTotalCount200>(
...
export type GetAllLocationsClientResult = NonNullable<PagedModelLocationResponseDTO>
export type CreateLocationClientResult = NonNullable<LocationResponseDTO>
export type GetTotalCountClientResult = NonNullable<GetTotalCount200>
