...
export class NoncommunicablediseaseManagementService {
  constructor(
 ...
 getAllNCD<TData = PagedModelNCDResponseDTO>(
  ...
  ): Observable<HttpEvent<TData>>;getAllNCD<TData = PagedModelNCDResponseDTO>(
 ...
 getCount<TData = GetCount200>(
  ...
  ): Observable<HttpEvent<TData>>;getCount<TData = GetCount200>(
...
export type GetAllNCDClientResult = NonNullable<PagedModelNCDResponseDTO>
export type CreateNCDClientResult = NonNullable<NCDResponseDTO>
export type GetCountClientResult = NonNullable<GetCount200>
