...
public class AshaController {
	...
	@GetMapping
    @Operation(summary = "Get all Asha", description = "Returns Asha in pageable")
	@ApiResponses(value = {
		    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Success", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AshaDTO.class))),
